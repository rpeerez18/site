...
<head>
    ...
    <link rel="shortcut icon" href="/res/site/img/icons8-glasses-100.png" type="image/x-icon">
</head>
<body>
<!--Inicio do Código-->
<!--barra de cabeçalho-->
...
<!--fim da barra de cabeçalho-->
<!--barra de menu-->
<header id="cabeca2">
<main class="container">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            <a class="navbar-brand" href="index.html"><img src="/res/site/img/logotipo2.jpg" alt="logo óticas x" width="100px"></a>
